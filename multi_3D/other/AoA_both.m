...
if IF.save
    save(sprintf('~/Jayden/Imaging with ML/result/1015/o_%s_fa.mat',obj_ref),'sp_P');
elseif IF.load
    load(sprintf('~/Jayden/Imaging with ML/result/1015/o_%s_fa.mat',obj_ref),'sp_P');
end

%%
sp_P_th = max(sp_P(:))*0.05;
